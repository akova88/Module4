...
public class DepositAPI {
    ...
    public ResponseEntity<?> deposit(@PathVariable("customerId") String customerIdStr, @Valid @RequestBody DepositCreReqDTO depositCreReqDTO, BindingResult bindingResult) {
